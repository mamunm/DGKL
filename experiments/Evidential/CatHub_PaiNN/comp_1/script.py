"""Evidential model training with hyperparameters optimization."""
...
from cat_uncertainty.evidential_model.train_painn import train_painn
...
logger = Console("evidential_training.log")
MAX_EPOCHS = 200
SEED = 31170
HP_MAX_EPOCHS = 25
HP_NUM_RUN = 25
...
logger.print("Strat evidential training...")
...
data_module, pl_module = train_painn(
    ...
    seed=SEED, 
    project="evidential_painn_cathub", 
    name="run_31170",
    htune=False
)

evidential = pl_module.model
device = torch.device("cuda:0" if torch.cuda.is_available() else "cpu")
evidential = evidential.to(device)
...
for split in ["train", "val", "test"]:
    ...
    with torch.no_grad():
        for batch in loader:
            ...
            y_pred, lambda_, alpha, beta = evidential(z, pos, graph_batch)
